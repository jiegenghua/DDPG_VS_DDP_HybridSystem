...
save('DDP_Sea_result.mat','control','state');
% Plot Results

figure('Position',[300 100 624 564]);
subplot(2,2,1)
hold on
plot([0 10],[5 5], 'b','LineWidth', 2);
plot([0 10],[10 10],'b', 'LineWidth', 2);
plot([3 3],[0 10], 'b','LineWidth', 2);
plot([7 7],[0 10],'b', 'LineWidth', 2);
plot([10 10],[0 10], 'b','LineWidth', 2);
...
plot(time(1:size(control,2)-1), l,'LineWidth',2); hold on
xlabel('Time[s]');
ylabel('Gains');
legend('K','k','l');
